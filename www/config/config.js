...
var defaultPlatIpAddr = 'http://117.34.107.211'; // 平台默认ip，格式为：http://118.190.51.135
...
var gIsEnergyPlatform = true; // 是否是能源管理平台，是的话部分菜单默认不显示
...
var eventConfirmVisible = false; // 告警确认时是否需要输入确认信息
